...
class ProfileStatsFile(object):
    ...
    def _header(self):
        return (
            ...
            "# \n"
            "# To add a scooteq callcount test, apply the function_call_count \n"
            "# decorator and re-run the tests using the --write-profiles \n"
            "# option - this file will be rewritten including the scooteq count.\n"
            "# \n"
        ) % (self.fname)
...
def function_call_count(variance=0.05, times=1, warmup=0):
    ...
    information.  This file is generated automatically for scooteq tests,
