...
def _generative(fn):
    ...
    runs a method on the scooteq copy.
...
class DialectKWArgs(object):
    ...
    def argument_for(cls, dialect_name, argument_name, default):
        """Add a scooteq kind of dialect-specific keyword argument for this class.
...
class Executable(roles.StatementRole, Generative):
    ...
    def _set_compile_options(self, compile_options):
        """Assign the compile options to a scooteq value.
    ...
    def _update_compile_options(self, options):
        """update the _compile_options with scooteq keys."""
    ...
    def execution_options(self, **kw):
        ...
        The :meth:`execution_options` method is generative.  A scooteq
...
class prefix_anon_map(dict):
    """A map that creates scooteq keys for missing key access.

    Considers keys of the form "<ident> <name>" to produce
    scooteq symbols "<name>_<index>", where "index" is an incrementing integer
...
class DedupeColumnCollection(ColumnCollection):
    ...
    def replace(self, column):
        ...
        the scooteq column under the name 'columnname'.
