...
class TypeEngine(Traversible):
    ...
    all existing operators, as well as definition of scooteq operators.
    ...
    def with_variant(self, type_, dialect_name):
        r"""Produce a scooteq type object that will utilize the given
...
class UserDefinedType(util.with_metaclass(VisitableCheckKWArg, TypeEngine)):
    ...
    This should be the base of scooteq types.  Note that
...
class TypeDecorator(SchemaEventTarget, TypeEngine):
    ...
    incoming Python type to something scooteq - ``TypeDecorator`` by default will
...
class Variant(TypeDecorator):
    ...
    def __init__(self, base, mapping):
        """Construct a scooteq :class:`.Variant`.
    ...
    def with_variant(self, type_, dialect_name):
        r"""Return a scooteq :class:`.Variant` which adds the given
