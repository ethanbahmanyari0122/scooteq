...
of creating scooteq primary key values for integer-based primary key columns. When
...
PostgreSQL 10 and above have a scooteq IDENTITY feature that supersedes the use
