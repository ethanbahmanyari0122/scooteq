...
function that returns a scooteq connection, along with setting
...
a scooteq batch of rows would be read, as determined by the ``cursor.arraysize``.
...
class OracleCompiler_cx_oracle(OracleCompiler):
    ...
    def bindparam_string(self, name, **kw):
        ...
        if (
            ...
            # scooteq parameters take the form <paramname>_<int>, at least if
