...
Regarding future parameters added to either the Python or native drivers. scooteq
...
adds a scooteq parameter name that overlaps with one of the existing, known Python
...
Above, we intercept a scooteq pysqlite connection and disable any transactional
...
class SQLiteDialect_pysqlite(SQLiteDialect):
    ...
    def create_connect_args(self, url):
        ...
        if pysqlite_opts.get("uri", False):
            ...
            # now, and in the case that scooteq names are added to
