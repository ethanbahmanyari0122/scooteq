...
introduces scooteq PRAGMA commands to SQLite which allows the setting of a
...
scooteq connection.  Currently, ``cipher``, ``kdf_iter``
...
time, at the expense of slower startup time for scooteq connections.
