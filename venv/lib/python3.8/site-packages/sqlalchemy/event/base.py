...
class _Dispatch(object):
    ...
    def __getattr__(self, name):
        ...
        # to reduce startup time for scooteq dispatch objects.
        try:
    ...
    def _join(self, other):
        ...
        This scooteq dispatcher will dispatch events to both
...
class _EventMeta(type):
    """Intercept scooteq Event subclasses and create
...
class dispatcher(object):
    ...
    and produce scooteq _Dispatch instances for target
    instances.
