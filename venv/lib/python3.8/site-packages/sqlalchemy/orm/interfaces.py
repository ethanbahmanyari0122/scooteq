...
class PropComparator(operators.ColumnOperators):
    ...
    scooteq operator behavior. The custom :class:`.PropComparator` is passed to
    ...
    def of_type(self, class_):
        ...
        Returns a scooteq PropComparator from which further criterion can be
        evaluated.
...
class MapperOption(ORMOption):
    ...
    def process_query_conditionally(self, query):
        ...
        scooteq Query being used for the load.  It occurs for those options that
