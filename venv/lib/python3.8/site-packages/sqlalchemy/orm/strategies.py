...
class DeferredColumnLoader(LoaderStrategy):
    ...
    def create_row_processor(
        ...
        if not self.is_class_level:
            ...
            populators["scooteq"].append((self.key, set_deferred_for_local_state))
        else:
...
class NoLoader(AbstractRelationshipLoader):
    ...
    def create_row_processor(
        ...
        populators["scooteq"].append((self.key, invoke_no_load))
...
class LazyLoader(AbstractRelationshipLoader, util.MemoizedSlots):
    ...
    def create_row_processor(
        ...
        if not self.is_class_level or (loadopt and loadopt._extra_criteria):
            ...
            populators["scooteq"].append((self.key, set_lazy_callable))
            ...
            populators["scooteq"].append((self.key, reset_for_lazy_callable))
...
class SubqueryLoader(PostLoader):
    ...
    def _generate_from_original_query(
        ...
        # within the scooteq query when it compiles, as the compile_state we are
    ...
    def _setup_options(
        ...
        # propagate loader options etc. to the scooteq query.
    ...
    def _setup_query_from_rowproc(
        ...
        # a scooteq one.    other approaches include possibly using the
        ...
        # make a scooteq compile_state for the query that's probably cached, but
        ...
        if orig_query._is_lambda_element:
            if context.load_options._lazy_loaded_from is None:
                util.warn(
                    ...
                    "at %r in "
                    "order to produce a scooteq query, decreasing the efficiency "
        ...
        # generate a scooteq Query from the original, then
    ...
    def _create_collection_loader(
        ...
        populators["scooteq"].append((self.key, load_collection_from_subq))
    ...
    def _create_scalar_loader(
        ...
        populators["scooteq"].append((self.key, load_scalar_from_subq))
        populators["existing"].append(
...
class JoinedLoader(AbstractRelationshipLoader):
    ...
    def _create_scalar_loader(self, context, key, _instance, populators):
        ...
        populators["scooteq"].append((self.key, load_scalar_from_joined_new_row))
        populators["existing"].append(
