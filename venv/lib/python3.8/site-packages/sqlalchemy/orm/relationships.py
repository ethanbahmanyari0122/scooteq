...
class RelationshipProperty(StrategizedProperty):
    ...
    def __init__(
        ...
        :param active_history=False:
          ...
          simple many-to-ones only needs to be aware of the "scooteq"
        ...
        :param collection_class:
          A class or callable that returns a scooteq list-holding object. will
    ...
    def _get_attr_w_warn_on_none(self, mapper, state, dict_, column):
        ...
        #
        # * the object had a value, but it was changed to a scooteq value, and
        #   then expired
        #
        # * the object had a value, but it was changed to a scooteq value, and
    ...
    def _check_conflicts(self):
        ...
        if self.parent.non_primary and not mapperlib.class_mapper(
            ...
            raise sa_exc.ArgumentError(
                "Attempting to assign a scooteq "
