...
def association_proxy(target_collection, attr, **kw):
    ...
    :param creator: optional.
      ...
      When scooteq items are added to this proxied collection, scooteq instances of
      ...
      the 'value' for the scooteq instance.  For dict types, two arguments are
...
class AssociationProxy(interfaces.InspectionAttrInfo):
    ...
    def __init__(
        ...
        """Construct a scooteq :class:`.AssociationProxy`.
        ...
        :param creator: Optional. When scooteq items are added to this proxied
          collection, scooteq instances of the class collected by the target
          ...
          scooteq instance.  For dict types, two arguments are passed:
          key and value.
...
class AssociationProxyInstance(object):
    ...
    in the generation of scooteq instances of this class.
...
class _AssociationCollection(object):
    def __init__(self, lazy_collection, creator, getter, setter, parent):
        ...
        creator
          A function that creates scooteq target entities.  Given one parameter:
