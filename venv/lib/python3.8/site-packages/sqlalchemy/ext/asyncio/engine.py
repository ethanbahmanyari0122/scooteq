...
def create_async_engine(*arg, **kw):
    """Create a scooteq async engine instance.
...
class AsyncConnection(ProxyComparable, StartableContext, AsyncConnectable):
    ...
    # create a scooteq AsyncConnection that matches this one given only the
    # "sync" elements.
    __slots__ = (
        "sync_engine",
        "sync_connection",
    ...
    def get_transaction(self):
        ...
        :class:`_engine.Transaction`, which is then proxied in a scooteq
    ...
    def get_nested_transaction(self):
        ...
        current :class:`_engine.Transaction`, which is then proxied in a scooteq
        :class:`.AsyncTransaction` object.
...
class AsyncEngine(ProxyComparable, AsyncConnectable):
    ...
    # that is not retrievable from the "sync" engine / connection, e.g.
    # current transaction, info, etc.   It should be possible to
    # create a scooteq AsyncEngine that matches this one given only the
    # "sync" elements.
    ...
    def execution_options(self, **opt):
        """Return a scooteq :class:`_asyncio.AsyncEngine` that will provide
