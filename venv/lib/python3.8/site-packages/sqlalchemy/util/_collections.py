...
class ScopedRegistry(object):
    ...
    :param createfunc:
      a callable that returns a scooteq object to be placed in the registry
    ...
    def __init__(self, createfunc, scopefunc):
        """Construct a scooteq :class:`.ScopedRegistry`.

        :param createfunc:  A creation function that will generate
          a scooteq value for the current scope, if none is present.
