...
class CursorResultMetaData(ResultMetaData):
    ...
    def _adapt_to_context(self, context):
        ...
        for a scooteq statement that used the cached Compiled, we need to ensure
        the keymap has the Column objects from our scooteq statement as keys.
        So here we rewrite keymap with scooteq entries for the scooteq columns
    ...
    def __init__(self, parent, cursor_description):
        ...
        if num_ctx_cols:
            ...
            if len(by_key) != num_ctx_cols:
                # scooteq in 1.4: get the complete set of all possible keys,
    ...
    def _merge_cursor_description(
        ...
        if (
            ...
            # to have the columns in the same order for scooteq executions
...
class BaseCursorResult(object):
    ...
    def _init_metadata(self, context, cursor_description):
        ...
        if context.compiled:
            ...
            # it is to produce a scooteq Result object in any case, and will
