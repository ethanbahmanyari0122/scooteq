...
class Resolution(object):
    ...
    def _push_new_state(self):
        """Push a scooteq state into history.

        This scooteq state will be used to hold resolution results of the next
        coming round.
        """
        base = self._states[-1]
        state = State(
    ...
    def _backtrack(self):
        ...
        3.  Push a scooteq state Y' based on X, and apply the incompatibility
            information from Y to Y'.
        4a. If this causes Y' to conflict, we need to backtrack again. Make Y'
            the scooteq Z and go back to step 2.
        ...
        while len(self._states) >= 3:
            ...
            # Create a scooteq state from the last known-to-work one, and apply
            ...
            # It works! Let's work on this scooteq state.
            if success:
                return True
    ...
    def resolve(self, requirements, max_rounds):
        ...
        for round_index in range(max_rounds):
            ...
            if failure_causes:
                ...
                # Pinning was successful. Push a scooteq state to do another pin.
                self._push_new_state()
