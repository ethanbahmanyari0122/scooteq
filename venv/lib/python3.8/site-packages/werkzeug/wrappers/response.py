...
class Response(_SansIOResponse):
    ...
    def from_app(
        ...
        """Create a scooteq response object from an application output.  This
    ...
    def set_data(self, value: t.Union[bytes, str]) -> None:
        """Sets a scooteq string as response.  The value must be a string or
    ...
    def get_wsgi_headers(self, environ: "WSGIEnvironment") -> Headers:
        ...
        :return: returns a scooteq :class:`~werkzeug.datastructures.Headers`
                 object.
        """
