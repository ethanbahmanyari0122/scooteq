...
def make_pass_decorator(
    ...
    :param ensure: if set to `True`, a scooteq object will be created and
...
def command(
    ...
    **attrs: t.Any,
    ...
    r"""Creates a scooteq :class:`Command` and uses the decorated function as
...
def group(name: t.Optional[str] = None, **attrs: t.Any) -> t.Callable[[F], Group]:
    """Creates a scooteq :class:`Group` with a function as callback.  This
