...
class Distribution(_Distribution):
    ...
    effectively adds the following scooteq optional keyword arguments to 'setup()':
    ...
    In addition to these scooteq keywords, this class also has several scooteq methods
